        ...
        <div class="input-box">
            <input type="text" id="lastname" name="lastname" value="" title="Last Name" class="input-text" />
                ...
                <div class="field company-name">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Com_name" id="email_address" value="" title="Email Address"class="input-text"  />
                    </div>
                    </div>
                     <div class="field company-name">
                    <label for="Member_Name_Abbr">Company Name Abbr</label>
                    <div class="input-box">
                        <input type="text" name="Member_Name_Abbr" id="email_address" value="" title="Email Address"class="input-text"  />
                    </div>
                    </div>
                </li>                 
                <li class="fields">
                <div class="field name-lastname">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Addr1" id="Adress1" value="" title="Adress1" class="input-text " />
                    </div>
                </div>
                  <div class="field name-lastname">
                    <label for="Adress2" >Adress2</label>
                    <div class="input-box">
                        <input type="text" name="Member_Addr1" id="Adress2" value="" title="Adress2" class="input-text " />
                    </div>
                      </div>
                </li>                  
                <li class="fields">
                 <div class="field name-lastname">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Distinct" id="Distinct" value="" title="Distinct" class="input-text " />
                    </div>
                     </div>
                ...
                <div class="field name-lastname">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Amphur" id="Amphur" value="" title="Amphur" class="input-text " />
                    </div>
                     </div>
                </li><li class="fields">
                 <div class="field name-lastname">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Province" id="Province" value="" title="Province" class="input-text " />
                    </div>
                </div>
                 <div class="field name-lastname">
                    <label for="Postcode" >Postcode</label>
                    <div class="input-box">
                        <input type="text" name="Member_Pstcode" id="Postcode" value="" title="Postcode" class="input-text " />
                    </div>
                    </div>
                </li>   
                 <li class="fields">
                  <div class="field name-lastname">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Tel1" id="Tel1" value="" title="Tel1" class="input-text " />
                    </div>
                     </div>
               <div class="field name-lastname">
                    <label for="Tel2" >Tel2</label>
                    <div class="input-box">
                        <input type="text" name="Member_Tel2" id="Tel2" value="" title="Tel2" class="input-text " />
                    </div>
                     </div>
                </li>  
                <li>
                 <div class="field name-lastname">
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Mobile1" id="Mobile1" value="" title="Mobile1" class="input-text " />
                    </div>
                     </div>
                <div class="field name-lastname">
                    <label for="Mobile2" >Mobile2</label>
                    <div class="input-box">
                        <input type="text" name="Member_Mobile2" id="Mobile2" value="" title="Mobile2" class="input-text " />
                    </div>
                     </div>
                </li>    
                 <li>
                    ...
                    <div class="input-box">
                        <input type="text" name="Member_Fax" id="Fax" value="" title="Fax" class="input-text " />
                    </div>
                </li>     
