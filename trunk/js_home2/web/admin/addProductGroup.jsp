        ...
        <script  type="text/javascript">
            jQuery(document).ready(function(){
                jQuery("#rowed1").jqGrid({        
                    ...
                    datatype: "xml",
                    colNames:['No','product Group', 'Group Name Th', 'Group Name En','Remark Th','Remark En'],
                    colModel:[
                        {name:'No',index:'No', width:80,editable:false,editoptions:{readonly:true,size:10}},
                        {name:'productGroup',index:'productGroup', width:150,editable:true,editoptions:{size:10}},
                        {name:'productGNameT',index:'productGNameT', width:150,editable:true,editoptions:{size:10}},
                        {name:'productGNameE',index:'productGNameE', width:150,editable:true,editoptions:{size:10}},
                        {name:'productRemarkT',index:'productRemarkT', width:140, align:"right",editable:true,editoptions:{size:25}},
                        {name:'productRemarkE',index:'productRemarkE', width:140, align:"right",editable:true,editoptions:{size:25}}	
