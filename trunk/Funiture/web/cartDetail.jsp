...
<script type="text/javascript" src="jshome/js/varien/form.js">t>
                ...
                <tfoot>
                    <tr>
                        <td colspan="50" class="a-right">
                                                            <button type="button" title="Continue Shopping" class="button btn-continue" onclick="location.href='category.jsp'"><span><span>Continue Shopping</span></span></button>
