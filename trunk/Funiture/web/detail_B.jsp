...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript" src="jshome/js/varien/product.js"></script>
        <script type="text/javascript" src="jshome/js/calendar/calendar.js"></script>
        <script type="text/javascript" src="jshome/js/calendar/calendar-setup.js"></script>
        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js"></script>
        <script type="text/javascript" src="jshome/js/slimbox2.js"></script>
        <link rel="stylesheet" href="jshome/css/slimbox2.css" type="text/css" media="screen" />
        --%>
        <!--[if lt IE 8]>
