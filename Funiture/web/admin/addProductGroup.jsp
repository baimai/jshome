                                ...
                                <div class="col-main">
                                    <div class="account-create">
                                        ...
                                        <form action="productGroup.do" method="post" id="form-validate"  enctype="multipart/form-data" >
                                            ...
                                            <c:if test="${param.valid==1}"><div class="valid_box" style="background-color: lightgreen; ">บันทึกข้อมูลเสร็จสิ้น</div></c:if>
                                            <c:if test="${param.error==1}"><div class="error_box" style="background-color: #EB340A;">ไม่สามารถบันทึกข้อมูลได้</div></c:if>
                                            <c:if test="${param.productGroupId==null}" >
