        ...
        <script  type="text/javascript">
            jQuery(document).ready(function(){
                jQuery("#rowed1").jqGrid({
                    ...
                    datatype: "xml",
                    colNames:['No','รหัสเกรด', 'ชื่อเกรด T ', 'ชื่อเกรด E ','ส่วนลด' ],
                    colModel:[
                        {name:'No',index:'No', width:60,editable:false,editoptions:{readonly:true,size:10}},
                        {name:'memberGrade',index:'memberGrade', width:180,editable:true,editoptions:{size:10}},
                        {name:'gradeNameT',index:'gradeNameT', width:288,editable:true,editoptions:{size:25}},
                        {name:'gradeNameE',index:'gradeNameE', width:288,editable:true,editoptions:{size:25}},
                        {name:'discountRate',index:'discountRate', width:288,editable:true,editoptions:{size:25}},
                        {name:'companyId',index:'companyId',  align:"right",hidden:true,editrules:{ edithidden:false},editable:true}
