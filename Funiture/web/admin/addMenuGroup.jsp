                                    ...
                                    <div class="account-create">
                                        ...
                                        <c:if test="${param.menuGroupId==null}" >
                                            <form action="menuGroupMaster.do" method="post" id="form-validate"  >
                                                ...
                                                <div class="fieldset">
                                                    <h2 class="legend">เพิ่มเมนูหลัก</h2>
                                                    ...
                                                    <ul class="form-list">
                                                        ...
                                                        <li>
                                                            ...
                                                            <button type="button" class="button" onClick="window.location='MenuGroup.jsp'" ><span><span>กลับ</span></span></button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </form>
                                        ...
                                        <c:if test="${param.menuGroupId!=null}" >
                                            <form action="menuGroupMaster.do" method="post" id="form-validate"  >
                                                <c:forEach var="menuGroupMaster" items="${query.rows}" >
                                                    ...
                                                    <div class="fieldset">
                                                        <h2 class="legend">แก้ไขเมนูหลัก</h2>
                                                        <img src="images/line.jpg" width="580" height="" alt=""/>
                                                        <ul class="form-list">
                                                            <li class="fields">
                                                                <div class="customer-name">
